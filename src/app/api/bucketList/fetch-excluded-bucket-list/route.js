...
export async function GET(req) {
  try {
    ...
    if (!influencer_id) {
      return new Response(JSON.stringify({ error: "Missing influencer_id parameter" }), { status: 400 });
    }
    ...
    const response = await backendAxiosInstance.get(`${API_URL.FETCH_EXCLUDED_BUCKETLIST}`, {
