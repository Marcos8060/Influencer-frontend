    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-12 text-center">
        ...
        >
          ...
          <Text style={{ color: primaryColor }} className="font-medium">
            {countryFlags[countryName.toLowerCase()] || '🌐'} {formattedCountryName}
          </Text>
        </div>
        ...
        <Text className="text-lg text-gray-600 max-w-2xl mx-auto">
          Discover the most influential content creators across {formattedCountryName}
        </Text>
      </div>

      {/* Country Overview */}
      {countryData && (
        <div className="mb-8 bg-white p-6 rounded-xl shadow-sm border border-input">
          <Row gutter={[24, 24]}>
            <Col xs={24} md={8}>
              <div className="text-center p-4">
                <Title level={3} className="!mb-1 !text-gray-900">
                  {countryData.totalInfluencers.toLocaleString()}+
                </Title>
                <Text type="secondary">Verified Creators</Text>
              </div>
            </Col>
            <Col xs={24} md={8}>
              <div className="text-center p-4">
                ...
                <div className="flex justify-center gap-2 flex-wrap">
                  {countryData.topCities.map((city, i) => (
            ...
            <Col xs={24} md={8}>
              <div className="text-center p-4">
                ...
                <div className="flex justify-center gap-2">
                  {countryData.popularPlatforms.map((platform, i) => (
      ...
      <div className="rounded-2xl p-8 md:p-12 text-center text-white" style={gradientStyle}>
        ...
        <Text className="text-blue-100 block mb-8 max-w-2xl mx-auto">
          Our regional experts can help you build effective influencer campaigns tailored to {formattedCountryName}'s market
        </Text>
        <Space>
          <Button 
            type="primary" 
