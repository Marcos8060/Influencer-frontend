...
const InstagramProfile = () => {
  ...
  const handleInstagramLogin = async () => {
    try {
      ...
      const url =
        `https://www.instagram.com/oauth/authorize?enable_fb_login=0&force_authentication=1&client_id=1252453379876445&redirect_uri=${encodeURIComponent('https://influencer-frontend-nu.vercel.app/auth/instagram-callback')}&response_type=code&scope=instagram_business_basic%2Cinstagram_business_manage_messages%2Cinstagram_business_manage_comments%2Cinstagram_business_content_publish%2Cinstagram_business_manage_insights`;
