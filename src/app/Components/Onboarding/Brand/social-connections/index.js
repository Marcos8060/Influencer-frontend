...
import { getInstagramResponse, getTiktokResponse } from '@/redux/features/socials';
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[300px] gap-8">
      ...
      <p className="text-gray-500 mb-6 text-center max-w-md">
        Connect your brand's social media accounts to unlock advanced analytics
        and campaign features. You can skip this step and connect later, but we
        recommend connecting now for the best experience.
      </p>
      ...
      <div className="mt-4 text-gray-400 text-xs text-center max-w-xs">
        We will never post or access your data without your permission. You can
        disconnect at any time in your account settings.
      </div>
    </div>
  );
};
