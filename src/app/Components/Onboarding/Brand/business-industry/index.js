...
const BusinessIndustry = () => {
  ...
  const industries = [
    { name: "Arts, Crafts & Creativity", icon: "🎨" },
    { name: "Automotive, Transport & EVs", icon: "🚗" },
    { name: "Beauty & Personal Care", icon: "💄" },
    { name: "Business, Finance & Career", icon: "💼" },
    { name: "Dating, Relationships & Adult Interests", icon: "💑" },
    { name: "Entrepreneurship & E-commerce", icon: "🛒" },
    { name: "Fashion & Apparel", icon: "👗" },
    { name: "Fitness & Sports", icon: "🏋️" },
    { name: "Food, Cooking & Dining", icon: "🍳" },
    { name: "Gaming & Esports", icon: "🎮" },
    { name: "Health & Wellness", icon: "🏥" },
    { name: "Home, Garden & DIY", icon: "🏡" },
    { name: "Luxury & High-End Lifestyle", icon: "💎" },
    { name: "Parenting & Family", icon: "👪" },
    { name: "Photography, Videography & Media", icon: "📷" },
    { name: "Social Issues & Advocacy", icon: "✊" },
    { name: "Sustainability & Eco-Friendly Living", icon: "🌱" },
    { name: "Technology & Gadgets", icon: "📱" },
    { name: "Travel & Experiences", icon: "✈️" },
    { name: "Lifestyle & Personal Development", icon: "🧘" },
  ];
