...
const PreferredBrandTypes = () => {
  ...
  const handleNext = () => {
    ...
    dispatch(updateFormData({ brandTypes: selectedCategory }));
    dispatch(nextStep());
  };
    ...
    <section className="flex items-center justify-center h-screen md:w-4/12 mx-auto px-4">
      <div className="w-full">
        <h1 className="text-3xl font-bold text-center my-2">
          What type of Brands are you interested in working with?
        </h1>
...
export default PreferredBrandTypes;
