...
const BrandOnboarding = () => {
  ...
  const steps = [
    { name: "Brand Details", icon: <FiInfo className="text-xl" />, component: <BrandDetails /> },
    { name: "Industry", icon: <FiFileText className="text-xl" />, component: <BusinessIndustry /> },
    { name: "Countries", icon: <FiCheckCircle className="text-xl" />, component: <Countries /> },
    { name: "Platforms", icon: <FiEye className="text-xl" />, component: <Platforms /> },
    { name: "About Us", icon: <FiFileText className="text-xl" />, component: <FindAboutUs /> },
    { name: "Terms", icon: <FiCheckCircle className="text-xl" />, component: <Terms /> }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-white to-secondary/10 py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        <div className="mb-10 rounded-lg shadow-sm bg-white/80 backdrop-blur-md border border-primary/10 p-8">
          {/* Steps Row */}
          <div className="hidden sm:flex flex-row w-full overflow-x-auto min-w-0 gap-x-6 sm:gap-x-10 items-center justify-between relative z-10">
