...
const InfluencerProfilePage = () => {
  ...
  let progressText =
    "Let's get started! Complete your profile for better discovery.";
  if (completion.percent >= 80) {
    progressColor = "#52c41a";
    progressText =
      "Awesome! Your profile is almost complete. You're more likely to get collaborations.";
  } else if (completion.percent >= 60) {
    progressColor = "#faad14";
    progressText =
      "Great progress! Complete a few more sections for better results.";
  } else if (completion.percent >= 40) {
    progressColor = "#1890ff";
    progressText =
      "Keep going! The more complete your profile, the more you'll be discovered.";
  }
                      ...
                      >
                        <div className="flex items-center">
                          <Avatar
                            size={64}
                            src={
                              influencerProfile?.instagram?.profilePictureUrl
                            }
                            className="mr-4"
                          />
                          <div>
