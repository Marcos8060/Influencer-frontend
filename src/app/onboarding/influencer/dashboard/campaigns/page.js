...
const Campaigns = () => {
  ...
  const filteredCampaigns = allCampaigns.filter((campaign) => {
    ...
    // Video style filter
    if (
      filters.videoStyle.length > 0 &&
      !filters.videoStyle.some((style) =>
    ...
    if (
      filters.socialChannels.length > 0 &&
      !filters.socialChannels.some((channel) =>
    ...
    if (
      filters.videoDuration.length > 0 &&
      !filters.videoDuration.includes(`${campaign.preferences.videoDuration}s`)
    ) {
      return false;
    }
    ...
    if (
      ...
      campaign.preferences.showFace !== filters.showFace
    ) {
      return false;
    }
    ...
    // Video format filter
    if (
      filters.videoFormat.length > 0 &&
      !filters.videoFormat.includes(campaign.preferences.videoFormat)
    ) {
      return false;
    }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onChange={(values) =>
                            handleFilterChange("videoStyle", values)
                          }
                          style={{ width: "100%" }}
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onChange={(values) =>
                            handleFilterChange("socialChannels", values)
                          }
                          style={{ width: "100%" }}
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onChange={(values) =>
                            handleFilterChange("videoDuration", values)
                          }
                          style={{ width: "100%" }}
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onChange={(value) =>
                            handleFilterChange("showFace", value)
                          }
                          style={{ width: "100%" }}
                        ...
                        <Space wrap>
                          ...
                          {filters.videoStyle.map((style) => (
                            <Tag
                              ...
                              closable
                              onClose={() => {
                                const newStyles = filters.videoStyle.filter(
                                  (s) => s !== style
                                );
                          ...
                          {filters.showFace !== null && (
                            ...
                            >
                              Face:{" "}
                              {filters.showFace ? "Required" : "Not Required"}
                            </Tag>
                          )}
                        </Space>
                      </div>
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="flex items-center gap-2 mt-2">
                                    <span className="bg-primary/10 text-primary text-xs px-2 py-1 rounded-full">
                                      {campaign.preferences.videosPerCreator}{" "}
                                      videos
                                    </span>
                        ...
                        >
                          <div className="space-y-4 max-w-md mx-auto">
                            ...
                            <p className="text-gray-500">
                              Your application is now pending approval. You'll
                              receive a notification once it's reviewed.
                            </p>
                            <button
                            ...
                            <div className="bg-gray-50 p-4 rounded-xl">
                              ...
                              <div className="space-y-2">
                                <div className="flex justify-between">
                                  ...
                                  <span className="font-medium">
                                    {selectedCampaign.preferences.showFace
                                      ? "Required"
                                      : "Not Required"}
                                  </span>
                                </div>
