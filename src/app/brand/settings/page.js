...
import { LockOutlined, InstagramOutlined, YoutubeOutlined } from '@ant-design/icons';
...
function formatPrice(amount, currency) {
  ...
  return `${(amount / 100).toLocaleString(undefined, { style: 'currency', currency: currency && currency.toUpperCase() })}`;
}
...
const SettingsPage = () => {
  ...
  return (
    <div className="w-full py-10 px-4">
      <h1 className="text-3xl font-bold mb-8 text-primary">Account & Subscription Settings</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        {/* Subscriptions Section */}
        <div className="col-span-1 flex flex-col gap-6">
          <h2 className="text-xl font-bold mb-2 text-primary">Your Active Subscriptions</h2>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-2">
                ...
                <div className="text-xl font-bold text-primary">
                  ...
                  <span className="ml-2 text-gray-500 text-base font-normal">/ {sub.plan_interval}</span>
                </div>
              </div>
              <div className="mb-2 text-sm text-gray-600">
                <strong>Next renewal:</strong> {formatDateFromUnix(sub.current_period_end)}
              </div>
              <div className="mb-2">
                <strong>Features:</strong>
                <ul className="list-disc ml-6 mt-1 text-gray-700">
                  {sub.plan_metadata && Object.entries(sub.plan_metadata).length > 0 ? (
                    ...
                    <li className="text-gray-400">No extra features listed.</li>
                  )}
                </ul>
              </div>
            </Card>
          ...
          <div className="bg-white rounded-xl shadow border border-input p-6">
            ...
            <div className="space-y-4">
              ...
              <Button
                ...
                disabled={pwdLoading || !changePwd.current || !changePwd.new || changePwd.new !== changePwd.confirm}
              >
                Save Password
              </Button>
              {pwdSuccess && <div className="text-green-600 text-center mt-2">Password changed successfully!</div>}
            </div>
          </div>
          {/* Social Accounts - Only Instagram and TikTok, Disconnect only */}
          <div className="bg-white rounded-xl shadow border border-input p-6">
            <h2 className="text-lg font-bold mb-4 text-primary">Social Accounts</h2>
      ...
      <div className="mt-16">
        <h2 className="text-xl font-bold mb-4 text-primary">Available Plans</h2>
            ...
            >
              <div className="flex flex-col gap-2 mb-2">
                ...
                <div className="text-xl font-bold text-primary">
                  ...
                  <span className="ml-2 text-gray-500 text-base font-normal">/ {plan.plan_interval}</span>
                </div>
              </div>
              <div className="mb-2">
                <strong>Features:</strong>
                <ul className="list-disc ml-6 mt-1 text-gray-700">
                  {plan.plan_metadata && Object.entries(plan.plan_metadata).length > 0 ? (
      ...
      >
        <div className="text-center">
          ...
          <p className="mb-4">Upgrade from <strong>{selectedPlan?.plan_nickname || 'Custom Plan'}</strong> to a higher tier. (Demo only)</p>
          <Button
            type="primary"
      ...
      >
        <div className="text-center">
          ...
          <p className="mb-4">Downgrade from <strong>{selectedPlan?.plan_nickname || 'Custom Plan'}</strong> to a lower tier. (Demo only)</p>
          <Button
            type="primary"
