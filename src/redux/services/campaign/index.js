...
export const fetchCampaignReport = async (auth, campaign_id) => {
    try {
        const url = `${APP_API_URL.CAMPAIGN_REPORT}`;
...
export const fetchCampaignPosts = async (auth, campaign_id) => {
    try {
        const url = `${APP_API_URL.CAMPAIGN_POST}`;
